...
DOCUMENTATION = r"""
---
module: database_test_connection
short_description: Gestiona recursos database_test_connection en Databasus.
description:
  - Permite gestionar recursos database_test_connection usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/databases/{id}/test-connection'

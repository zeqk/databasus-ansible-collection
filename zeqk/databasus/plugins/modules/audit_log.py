...
---
module: audit_log
short_description: Gestiona recursos audit_log en Databasus.
description:
  - Permite gestionar recursos audit_log usando la API de Databasus.
...
options:
  ...
  before_date:
    description:
      - Filter logs created before this date (RFC3339 format)
    type: str
  limit:
    description:
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/audit-logs/global'
LIST_PATH_PARAMS = []
LIST_QUERY_PARAMS = ['before_date', 'limit', 'offset']
GET_METHOD = 'GET'
GET_PATH = '/audit-logs/users/{userId}'
GET_PATH_PARAMS = ['user_id']
GET_QUERY_PARAMS = ['before_date', 'limit', 'offset']
UPDATE_METHOD = None
UPDATE_PATH = None
UPDATE_PATH_PARAMS = []
UPDATE_QUERY_PARAMS = []
...
BODY_FIELDS = []
READ_ONLY = True
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'limit': 'limit', 'offset': 'offset', 'before_date': 'beforeDate', 'user_id': 'userId'}
REQUIRED_DELETE_PATH_PARAMS = []
REQUIRED_GET_PATH_PARAMS = ['user_id']

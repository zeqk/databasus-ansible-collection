...
options:
  ...
  azure_blob_storage:
    description:
      - Campo azureBlobStorage del body.
    type: dict
  ftp_storage:
    description:
      - Campo ftpStorage del body.
    type: dict
  google_drive_storage:
    description:
      - Campo googleDriveStorage del body.
    type: dict
  id:
    description:
      - Campo id del body.
  ...
  last_save_error:
    description:
      - Campo lastSaveError del body.
    type: str
  local_storage:
    description:
      - Campo localStorage del body.
    type: dict
  name:
    description:
      - Campo name del body.
  ...
  nas_storage:
    description:
      - Campo nasStorage del body.
    type: dict
  rclone_storage:
    description:
      - Campo rcloneStorage del body.
    type: dict
  s3_storage:
    description:
      - Campo s3Storage del body.
    type: dict
  sftp_storage:
    description:
      - Campo sftpStorage del body.
    type: dict
  type:
    description:
      - Campo type del body.

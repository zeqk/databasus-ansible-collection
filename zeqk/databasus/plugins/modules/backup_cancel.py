...
short_description: Gestiona recursos backup_cancel en Databasus.
description:
  - Permite gestionar recursos backup_cancel usando la API de Databasus.
options:
  state:
    description:

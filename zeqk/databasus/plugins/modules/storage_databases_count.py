...
DOCUMENTATION = r"""
---
module: storage_databases_count
short_description: Gestiona recursos storage_databases_count en Databasus.
description:
  - Permite gestionar recursos storage_databases_count usando la API de Databasus.
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/backup-configs/storage/{id}/databases-count'
LIST_PATH_PARAMS = ['id']
LIST_QUERY_PARAMS = []
GET_METHOD = None
GET_PATH = None

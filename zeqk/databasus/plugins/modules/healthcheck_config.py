...
options:
  ...
  attempts_before_concidered_as_down:
    description:
      - Campo attemptsBeforeConcideredAsDown del body.
    type: int
  database_id:
    description:
  ...
  interval_minutes:
    description:
      - Campo intervalMinutes del body.
    type: int
  is_healthcheck_enabled:
    description:
      - Campo isHealthcheckEnabled del body.
    type: bool
  is_sent_notification_when_unavailable:
    description:
      - Campo isSentNotificationWhenUnavailable del body.
    type: bool
  store_attempts_days:
    description:
      - Campo storeAttemptsDays del body.
    type: int
author:
  - zeqk
"""

...
---
module: storage_test
short_description: Gestiona recursos storage_test en Databasus.
description:
  - Permite gestionar recursos storage_test usando la API de Databasus.
options:
  state:
    description:

...
---
module: backup_file
short_description: Gestiona recursos backup_file en Databasus.
description:
  - Permite gestionar recursos backup_file usando la API de Databasus.
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/backups/{id}/file'
LIST_PATH_PARAMS = ['id']
LIST_QUERY_PARAMS = ['token']
GET_METHOD = None
GET_PATH = None
GET_PATH_PARAMS = []
GET_QUERY_PARAMS = []
...
BODY_FIELDS = []
READ_ONLY = True
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'id': 'id', 'token': 'token'}

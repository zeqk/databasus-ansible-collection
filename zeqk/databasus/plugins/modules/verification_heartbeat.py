...
DOCUMENTATION = r"""
---
module: verification_heartbeat
short_description: Gestiona recursos verification_heartbeat en Databasus.
description:
  - Permite gestionar recursos verification_heartbeat usando la API de Databasus.
options:
  state:
    description:
  ...
  max_concurrent_jobs:
    description:
      - Campo maxConcurrentJobs del body.
    type: int
  max_cpu:
    description:
      - Campo maxCpu del body.
    type: int
  max_disk_gb:
    description:
      - Campo maxDiskGb del body.
    type: int
  max_ram_gb:
    description:
      - Campo maxRamGb del body.
    type: int
author:
  - zeqk
"""
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/agent/verification/{agentId}/heartbeat'
CREATE_PATH_PARAMS = ['agent_id']
CREATE_QUERY_PARAMS = []
LIST_METHOD = None
LIST_PATH = None
LIST_PATH_PARAMS = []

...
options:
  ...
  is_scheduled_verification_enabled:
    description:
      - Campo isScheduledVerificationEnabled del body.
    type: bool
  schedule_type:
    description:
      - Campo scheduleType del body.
    type: str
  ...
  verification_interval:
    description:
      - Campo verificationInterval del body.
    type: dict
author:
  - zeqk
"""
...
LIST_QUERY_PARAMS = []
GET_METHOD = 'GET'
GET_PATH = '/verification-config/{databaseId}'
GET_PATH_PARAMS = ['database_id']
GET_QUERY_PARAMS = []
UPDATE_METHOD = 'PUT'
UPDATE_PATH = '/verification-config/{databaseId}'
UPDATE_PATH_PARAMS = ['database_id']
UPDATE_QUERY_PARAMS = []
DELETE_METHOD = None
DELETE_PATH = None
DELETE_PATH_PARAMS = []

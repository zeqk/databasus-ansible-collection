...
DOCUMENTATION = r"""
---
module: restore_restore
short_description: Gestiona recursos restore_restore en Databasus.
description:
  - Permite gestionar recursos restore_restore usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/restores/{backupId}/restore'

...
DOCUMENTATION = r"""
---
module: database_restore_token
short_description: Gestiona recursos database_restore_token en Databasus.
description:
  - Permite gestionar recursos database_restore_token usando la API de Databasus.
options:
  state:
    description:
  ...
  target_time:
    description:
      - TargetTime is the PITR target; omit for a restore to the latest available point.
    type: str
author:
  - zeqk
"""
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/backups/physical/database/{id}/restore-token'
...
DELETE_PATH_PARAMS = []
DELETE_QUERY_PARAMS = []
BODY_FIELDS = ['target_time']
READ_ONLY = False
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'state': 'state', 'id': 'id', 'target_time': 'targetTime'}

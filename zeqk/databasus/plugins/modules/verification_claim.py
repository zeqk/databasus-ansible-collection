...
DOCUMENTATION = r"""
---
module: verification_claim
short_description: Gestiona recursos verification_claim en Databasus.
description:
  - Permite gestionar recursos verification_claim usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/agent/verifications/{agentId}/claim'
...
DELETE_PATH_PARAMS = []
DELETE_QUERY_PARAMS = []
BODY_FIELDS = ['capacity']
READ_ONLY = False
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'state': 'state', 'agent_id': 'agentId', 'capacity': 'capacity'}

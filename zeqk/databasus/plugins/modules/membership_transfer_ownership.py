...
DOCUMENTATION = r"""
---
module: membership_transfer_ownership
short_description: Gestiona recursos membership_transfer_ownership en Databasus.
description:
  - Permite gestionar recursos membership_transfer_ownership usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/workspaces/memberships/{id}/transfer-ownership'
...
def run_module() -> None:
    module_args = dict(
        ...
        id=dict(type='str'),
        new_owner_email=dict(type='str', required=True),
    )

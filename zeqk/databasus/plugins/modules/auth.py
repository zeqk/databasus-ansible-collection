...
---
module: auth
short_description: Gestiona recursos auth en Databasus.
description:
  - Permite gestionar recursos auth usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/auth/github/callback'
CREATE_PATH_PARAMS = []
CREATE_QUERY_PARAMS = []
LIST_METHOD = None
LIST_PATH = None
...
DELETE_PATH_PARAMS = []
DELETE_QUERY_PARAMS = []
BODY_FIELDS = ['code', 'redirect_uri']
READ_ONLY = False
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'state': 'state', 'code': 'code', 'redirect_uri': 'redirectUri'}

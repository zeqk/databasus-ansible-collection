...
DOCUMENTATION = r"""
---
module: notifier_is_using
short_description: Gestiona recursos notifier_is_using en Databasus.
description:
  - Permite gestionar recursos notifier_is_using usando la API de Databasus.
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/databases/notifier/{id}/is-using'
LIST_PATH_PARAMS = ['id']
LIST_QUERY_PARAMS = []
GET_METHOD = None
GET_PATH = None

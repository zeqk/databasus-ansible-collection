...
DOCUMENTATION = r"""
---
module: user_deactivate
short_description: Gestiona recursos user_deactivate en Databasus.
description:
  - Permite gestionar recursos user_deactivate usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/users/{id}/deactivate'

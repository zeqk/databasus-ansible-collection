...
DOCUMENTATION = r"""
---
module: agent_rotate_token
short_description: Gestiona recursos agent_rotate_token en Databasus.
description:
  - Permite gestionar recursos agent_rotate_token usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/verification/agents/{id}/rotate-token'

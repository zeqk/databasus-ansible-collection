...
---
module: agent
short_description: Gestiona recursos agent en Databasus.
description:
  - Permite gestionar recursos agent usando la API de Databasus.
options:
  state:
    description:
  ...
  db_size_bytes_after_restore:
    description:
      - Campo dbSizeBytesAfterRestore del body.
    type: int
  fail_message:
    description:
      - Campo failMessage del body.
    type: str
  failure_kind:
    description:
      - Campo failureKind del body.
    type: str
  id:
    description:
      - Verification UUID
  ...
  pg_restore_exit_code:
    description:
      - Campo pgRestoreExitCode del body.
    type: int
  restore_duration_ms:
    description:
      - Campo restoreDurationMs del body.
    type: int
  schema_count:
    description:
      - Campo schemaCount del body.
    type: int
  status:
    description:
      - Campo status del body.
    type: dict
    required: true
  table_count:
    description:
      - Campo tableCount del body.
    type: int
  table_stats:
    description:
      - Campo tableStats del body.
    type: list
  verify_duration_ms:
    description:
      - Campo verifyDurationMs del body.
    type: int
author:
  - zeqk
"""

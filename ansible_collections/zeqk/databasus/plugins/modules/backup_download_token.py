...
DOCUMENTATION = r"""
---
module: backup_download_token
short_description: Gestiona recursos backup_download_token en Databasus.
description:
  - Permite gestionar recursos backup_download_token usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/backups/{id}/download-token'

...
DOCUMENTATION = r"""
---
module: verification_cancel
short_description: Gestiona recursos verification_cancel en Databasus.
description:
  - Permite gestionar recursos verification_cancel usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/verifications/{id}/cancel'

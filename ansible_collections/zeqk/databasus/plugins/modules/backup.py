...
LIST_PATH = '/backups'
LIST_PATH_PARAMS = []
LIST_QUERY_PARAMS = ['before_date', 'database_id', 'limit', 'offset', 'pg_wal_backup_type', 'status']
GET_METHOD = None
GET_PATH = None
GET_PATH_PARAMS = []
GET_QUERY_PARAMS = []
...
DELETE_QUERY_PARAMS = []
BODY_SCHEMA = {
    'database_id': {'api': 'database_id', 'type': 'str'},
}
READ_ONLY = False
API_NAME_MAP = {
    'api_url': 'api_url',
...
REQUIRED_LIST_QUERY_PARAMS = ['database_id']
...
def run_module() -> None:
    module_args = dict(
        ...
        pg_wal_backup_type=dict(type='str', choices=['PG_FULL_BACKUP', 'PG_WAL_SEGMENT']),
        status=dict(type='list', elements='str', choices=['IN_PROGRESS', 'COMPLETED', 'FAILED', 'CANCELED']),
    )

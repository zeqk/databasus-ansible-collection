...
short_description: Gestiona recursos backup_config en Databasus.
description:
  - Permite gestionar recursos backup_config usando la API de Databasus.
options:
  state:
    description:
  ...
  backup_interval:
    description:
      - Campo backupInterval del body.
    type: dict
  database_id:
    description:
      - Campo databaseId del body.
    type: str
  encryption:
    description:
      - Campo encryption del body.
    type: str
  id:
    description:
      - Database ID
  ...
  is_backups_enabled:
    description:
      - Campo isBackupsEnabled del body.
    type: bool
  is_retry_if_failed:
    description:
      - Campo isRetryIfFailed del body.
    type: bool
  max_failed_tries_count:
    description:
      - Campo maxFailedTriesCount del body.
    type: int
  retention_count:
    description:
      - Campo retentionCount del body.
    type: int
  retention_gfs_days:
    description:
      - Campo retentionGfsDays del body.
    type: int
  retention_gfs_hours:
    description:
      - Campo retentionGfsHours del body.
    type: int
  retention_gfs_months:
    description:
      - Campo retentionGfsMonths del body.
    type: int
  retention_gfs_weeks:
    description:
      - Campo retentionGfsWeeks del body.
    type: int
  retention_gfs_years:
    description:
      - Campo retentionGfsYears del body.
    type: int
  retention_policy_type:
    description:
      - Campo retentionPolicyType del body.
    type: str
  retention_time_period:
    description:
      - Campo retentionTimePeriod del body.
    type: str
  send_notifications_on:
    description:
      - Campo sendNotificationsOn del body.
    type: list
  storage:
    description:
      - Campo storage del body.
    type: dict
  storage_id:
    description:
      - Campo storageId del body.
    type: str
author:
  - zeqk
"""

...
options:
  ...
  attempts_before_concidered_as_down:
    description:
      - Body field attemptsBeforeConcideredAsDown.
    type: int
  database_id:
    description:
  ...
  is_healthcheck_enabled:
    description:
      - Body field isHealthcheckEnabled.
    type: bool
  is_sent_notification_when_unavailable:
    description:
      - Body field isSentNotificationWhenUnavailable.
    type: bool
  store_attempts_days:
    description:
      - Body field storeAttemptsDays.
    type: int
author:
    - zeqk (@zeqk)
"""
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/healthcheck-config'
CREATE_PATH_PARAMS = []
CREATE_QUERY_PARAMS = []
LIST_METHOD = None
LIST_PATH = None
...
LIST_QUERY_PARAMS = []
GET_METHOD = 'GET'
GET_PATH = '/healthcheck-config/{databaseId}'
GET_PATH_PARAMS = ['database_id']
GET_QUERY_PARAMS = []
UPDATE_METHOD = None
UPDATE_PATH = None
UPDATE_PATH_PARAMS = []
...
DELETE_QUERY_PARAMS = []
BODY_SCHEMA = {
    'attempts_before_concidered_as_down': {'api': 'attemptsBeforeConcideredAsDown', 'type': 'int'},
    'database_id': {'api': 'databaseId', 'type': 'str'},
    'interval_minutes': {'api': 'intervalMinutes', 'type': 'int'},
    'is_healthcheck_enabled': {'api': 'isHealthcheckEnabled', 'type': 'bool'},
    'is_sent_notification_when_unavailable': {'api': 'isSentNotificationWhenUnavailable', 'type': 'bool'},
    'store_attempts_days': {'api': 'storeAttemptsDays', 'type': 'int'},
}
READ_ONLY = False
API_NAME_MAP = {
    'api_url': 'api_url',
...
def run_module() -> None:
    module_args = dict(
        ...
        store_attempts_days=dict(type='int'),
    )

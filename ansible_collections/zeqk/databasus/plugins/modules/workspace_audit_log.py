...
DOCUMENTATION = r"""
---
module: workspace_audit_log
short_description: Gestiona recursos workspace_audit_log en Databasus.
description:
  - Permite gestionar recursos workspace_audit_log usando la API de Databasus.
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/workspaces/{id}/audit-logs'
LIST_PATH_PARAMS = ['id']
...
BODY_FIELDS = []
READ_ONLY = True
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'id': 'id', 'limit': 'limit', 'offset': 'offset', 'before_date': 'beforeDate'}

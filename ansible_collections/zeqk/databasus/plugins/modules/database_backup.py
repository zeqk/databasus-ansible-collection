...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/backups/physical/database/{id}/backups'
LIST_PATH_PARAMS = ['id']
LIST_QUERY_PARAMS = ['before_date', 'limit', 'offset', 'status', 'type']
GET_METHOD = None
GET_PATH = None
GET_PATH_PARAMS = []
GET_QUERY_PARAMS = []
...
def run_module() -> None:
    module_args = dict(
        ...
        type=dict(type='list', elements='str', choices=['FULL', 'INCREMENTAL', 'WAL']),
    )

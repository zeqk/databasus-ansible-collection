...
short_description: Gestiona recursos storage_transfer en Databasus.
description:
  - Permite gestionar recursos storage_transfer usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/storages/{id}/transfer'
...
DELETE_PATH_PARAMS = []
DELETE_QUERY_PARAMS = []
BODY_FIELDS = ['target_workspace_id']
READ_ONLY = False
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'state': 'state', 'id': 'id', 'target_workspace_id': 'targetWorkspaceId'}

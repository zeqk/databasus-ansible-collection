...
DOCUMENTATION = r"""
---
module: storage_is_using
short_description: Gestiona recursos storage_is_using en Databasus.
description:
  - Permite gestionar recursos storage_is_using usando la API de Databasus.
...
- name: Consultar recurso
  zeqk.databasus.storage_is_using:
...
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/backup-configs/storage/{id}/is-using'
LIST_PATH_PARAMS = ['id']
LIST_QUERY_PARAMS = []
GET_METHOD = None
GET_PATH = None
...
BODY_FIELDS = []
READ_ONLY = True
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'id': 'id'}

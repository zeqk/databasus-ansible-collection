...
DOCUMENTATION = r"""
---
module: database_transfer
short_description: Gestiona recursos database_transfer en Databasus.
description:
  - Permite gestionar recursos database_transfer usando la API de Databasus.
options:
  state:
    description:
  ...
  is_transfer_with_notifiers:
    description:
      - Campo isTransferWithNotifiers del body.
    type: bool
  is_transfer_with_storage:
    description:
      - Campo isTransferWithStorage del body.
    type: bool
  target_notifier_ids:
    description:
      - Campo targetNotifierIds del body.
    type: list
  target_storage_id:
    description:
      - Campo targetStorageId del body.
    type: str
  target_workspace_id:
    description:
      - Campo targetWorkspaceId del body.
    type: str
    required: true
author:
  - zeqk
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/backup-configs/database/{id}/transfer'

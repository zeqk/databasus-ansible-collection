...
DOCUMENTATION = r"""
---
module: healthcheck_attempt
short_description: Gestiona recursos healthcheck_attempt en Databasus.
description:
  - Permite gestionar recursos healthcheck_attempt usando la API de Databasus.
...
LIST_QUERY_PARAMS = []
GET_METHOD = 'GET'
GET_PATH = '/healthcheck-attempts/{databaseId}'
GET_PATH_PARAMS = ['database_id']
GET_QUERY_PARAMS = ['after_date']
UPDATE_METHOD = None
UPDATE_PATH = None
UPDATE_PATH_PARAMS = []
UPDATE_QUERY_PARAMS = []

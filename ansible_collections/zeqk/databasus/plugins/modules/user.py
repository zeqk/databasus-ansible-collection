...
options:
  ...
  before_date:
    description:
      - Filter users created before this date (RFC3339 format)
    type: str
  email:
    description:
      - Body field email.
  ...
  intended_workspace_id:
    description:
      - Body field intendedWorkspaceId.
    type: str
  intended_workspace_role:
    description:
      - Body field intendedWorkspaceRole. Possible values; WORKSPACE_OWNER, WORKSPACE_ADMIN, WORKSPACE_MEMBER, WORKSPACE_VIEWER.
    type: str
    choices:
      - WORKSPACE_OWNER
      - WORKSPACE_ADMIN
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/users/invite'
CREATE_PATH_PARAMS = []
CREATE_QUERY_PARAMS = []
LIST_METHOD = 'GET'
LIST_PATH = '/users'
LIST_PATH_PARAMS = []
LIST_QUERY_PARAMS = ['before_date', 'limit', 'offset', 'query']
GET_METHOD = 'GET'
GET_PATH = '/users/{id}'
GET_PATH_PARAMS = ['id']
GET_QUERY_PARAMS = []

...
---
module: restore
short_description: Gestiona recursos restore en Databasus.
description:
  - Permite gestionar recursos restore usando la API de Databasus.
...
LIST_QUERY_PARAMS = []
GET_METHOD = 'GET'
GET_PATH = '/restores/{backupId}'
GET_PATH_PARAMS = ['backup_id']
GET_QUERY_PARAMS = []
UPDATE_METHOD = None
UPDATE_PATH = None
UPDATE_PATH_PARAMS = []
...
BODY_FIELDS = []
READ_ONLY = True
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'backup_id': 'backupId'}
REQUIRED_DELETE_PATH_PARAMS = []
REQUIRED_GET_PATH_PARAMS = ['backup_id']

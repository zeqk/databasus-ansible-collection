...
options:
  ...
  discord_notifier:
    description:
      - Campo discordNotifier del body.
    type: dict
  email_notifier:
    description:
      - Campo emailNotifier del body.
    type: dict
  id:
    description:
      - Campo id del body.
  ...
  notifier_type:
    description:
      - Campo notifierType del body.
    type: str
  slack_notifier:
    description:
      - Campo slackNotifier del body.
    type: dict
  teams_notifier:
    description:
      - Campo teamsNotifier del body.
    type: dict
  telegram_notifier:
    description:
      - Campo telegramNotifier del body.
    type: dict
  webhook_notifier:
    description:
      - Campo webhookNotifier del body.
    type: dict
  workspace_id:
    description:
      - Workspace ID

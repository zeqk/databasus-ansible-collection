...
DOCUMENTATION = r"""
---
module: backup_restore_token
short_description: Gestiona recursos backup_restore_token en Databasus.
description:
  - Permite gestionar recursos backup_restore_token usando la API de Databasus.
options:
  state:
    description:
...
CREATE_METHOD = 'POST'
CREATE_PATH = '/backups/physical/backups/{backupId}/restore-token'
CREATE_PATH_PARAMS = ['backup_id']
CREATE_QUERY_PARAMS = []
LIST_METHOD = None
LIST_PATH = None
LIST_PATH_PARAMS = []
...
BODY_FIELDS = []
READ_ONLY = False
API_NAME_MAP = {'api_url': 'api_url', 'api_token': 'api_token', 'state': 'state', 'backup_id': 'backupId'}
REQUIRED_DELETE_PATH_PARAMS = []
REQUIRED_GET_PATH_PARAMS = []
REQUIRED_CREATE_PATH_PARAMS = ['backup_id']
